...
func request_SayHi_SayHi_0(ctx context.Context, marshaler runtime.Marshaler, client SayHiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HiReq
...
func RegisterSayHiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SayHiClient) error {

	mux.Handle("POST", pattern_SayHi_SayHi_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_SayHi_SayHi_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SayHi_SayHi_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "sayhi"}, ""))
)

var (
	forward_SayHi_SayHi_0 = runtime.ForwardResponseMessage
)
